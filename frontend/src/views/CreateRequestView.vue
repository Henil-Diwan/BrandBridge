...
const createRequest = async () => {
    ...
    try {
        const response2 = await axios.post(
            "http://127.0.0.1:5001/create_request",
            requestData,
            {
                headers: {
...
<template>
  ...
  <div class="mb-3">
    ...
    <input v-model="req" type="text" class="form-control" id="exampleInputUsername1" aria-describedby="usernamelHelp">
  </div>
  
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Payment</label>
    <input v-model="payment" type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
