...
let registerInfluencer = async () => {
  try {
    ...
    const response = await axios.post(
      "http://127.0.0.1:5001/influencer_register",
      formData
    );
      ...
      <div class="container main">
        <div class="row">
          ...
          <div class="col-md-6 right">
            <div class="input-box">
              <header>Influencer Register</header>
              <form @submit.prevent="registerInfluencer">
                ...
                <div class="input-field">
                 ...
                 <div vmod class="dropdown-wrapper input-field">
                  <div>Category</div>
                <select v-model="category" class="form-control" id="dropdown1" name="Category">
              ...
              <div class="input-field">
                ...
                <div class="input-field">
                  ...
                  v-model="reach"
                    ...
                    name="Reach"
                  />
                  <label for="reach">Number of Followers</label>
                </div>
                <div class="input-field">
                  <div>
                    Profile Picture 
