        ...
        toast("User Registered Successfully", {
          ...
          onClose: () => {
            if (type.value === "sponsor") {
              router.push({path: `/sponsor_register/${response.data.user_id}`});
            } else {
              router.push({path: `/influencer_register/${response.data.user_id}`});
            }
          },
          autoClose: 1000
        });
            ...
            <div class="input-box">
              ...
              <form @submit.prevent="registerUser">
                ...
                <div class="dropdown-wrapper input-field">
                  <select v-model="type" id="dropdown" name="dropdown">
